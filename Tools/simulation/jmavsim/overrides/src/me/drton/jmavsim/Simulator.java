...
//  private int simDelayMax = 500;  // Max delay between simulated and real time to skip samples in simulator, in ms
    ...
    private AbstractMulticopter buildMulticopter() {
        ...
        vehicle.enableRotorModelVisualization(new String[] {
            "models/amovlab_prop_front_right.obj",
            "models/amovlab_prop_rear_left.obj",
            "models/amovlab_prop_front_left.obj",
            "models/amovlab_prop_rear_right.obj"
        }, new Vector3d[] {
            new Vector3d(0.143002870, 0.207743028, -0.205753751),
            new Vector3d(-0.142999314, -0.157421203, -0.205753751),
            new Vector3d(0.143000819, -0.207742283, -0.205753438),
            new Vector3d(-0.143001372, 0.157421943, -0.205753438)
        });
